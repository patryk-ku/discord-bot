	...
	const champions = {
		...
		data: {
			...
			Ambessa: {
				...
				info: { attack: 9, defense: 2, magic: 0, difficulty: 10 },
				image: {
					full: 'Ambessa.png',
					sprite: 'champion0.png',
					group: 'champion',
			...
			Skarner: {
				...
				info: { attack: 7, defense: 8, magic: 5, difficulty: 5 },
				image: {
					full: 'Skarner.png',
					sprite: 'champion4.png',
					group: 'champion',
...
exports.getSummonersNameById = (id) => {
	// https://ddragon.leagueoflegends.com/cdn/15.2.1/data/en_US/summoner.json
	const summoners = {
		type: 'summoner',
		version: '15.2.1',
		data: {
			SummonerBarrier: {
				id: 'SummonerBarrier',
				name: 'Barrier',
				description: 'Gain a 100-460 damage Shield for 2.5 seconds.',
				tooltip:
					'Gain a <shield>{{ shieldstrength }} damage Shield</shield> for {{ shieldduration }} seconds.',
				maxrank: 1,
				cooldown: [180],
				cooldownBurn: '180',
				cost: [0],
			...
			SummonerBoost: {
				...
				tooltip:
					'Removes all crowd control debuffs (excluding <keyword>Suppression</keyword> and <keyword>Airborne</keyword>) and summoner spell debuffs from you and grants {{ tenacityvalue*100 }}% Tenacity for {{ tenacityduration }} seconds.',
				maxrank: 1,
				cooldown: [240],
				cooldownBurn: '240',
				cost: [0],
			...
			SummonerCherryFlash: {
				...
				tooltip:
					"Teleports your champion a short distance toward your cursor's location.<br /><br />Cannot be cast again for one full round <rules>(a round consists of both a buy phase and a combat phase).</rules>",
				maxrank: 1,
				cooldown: [0.25],
				cooldownBurn: '0.25',
				cost: [0],
			...
			SummonerCherryHold: {
				...
				tooltip:
					'<keywordMajor>Active Spell Slot:</keywordMajor> Augments that grant a Summoner Spell will replace this slot.<br /><br />Gain <moveSpeed>{{ basems*100 }}% Move Speed</moveSpeed> for {{ duration }} seconds, increased by {{ bonusmsperenemybehind*100 }}% for each enemy behind you.',
				maxrank: 1,
				cooldown: [45],
				cooldownBurn: '45',
				cost: [0],
			...
			SummonerDot: {
				...
				name: 'Ignite',
				description:
					'Deals 70-410 true damage to target enemy champion over 5 seconds and reduces healing effects on them for the duration.',
				tooltip:
					'Deals <trueDamage>{{ tooltiptruedamagecalculation }} true damage</trueDamage> to target enemy champion over 5 seconds and applies <keyword>{{ grievousamount*100 }}% Grievous Wounds</keyword> for the duration.<br /><br /><keyword>Wounds</keyword>: Reduces the effectiveness of Healing and Regeneration effects.',
				maxrank: 1,
				cooldown: [180],
				cooldownBurn: '180',
				cost: [0],
			...
			SummonerExhaust: {
				...
				name: 'Exhaust',
				description:
					'Slows target enemy champion by 40% and reduces their damage dealt by 35% for 3 seconds.',
				tooltip:
					'<keyword>Slows</keyword> target enemy champion by {{ slow }}% and reduces their damage dealt by {{ damagereduction }}% for {{ debuffduration }} seconds.',
				maxrank: 1,
				cooldown: [240],
				cooldownBurn: '240',
				cost: [0],
			...
			SummonerHaste: {
				...
				tooltip:
					'Gain <speed>{{ movespeedmod }} Move Speed</speed> and become <keyword>Ghosted</keyword> for {{ duration }} seconds.<br /><br /><keyword>Ghost</keyword>: Ignore collision with other units.',
				maxrank: 1,
				cooldown: [240],
				cooldownBurn: '240',
				cost: [0],
			...
			SummonerSmite: {
				...
				tooltip:
					'Deals <trueDamage>{{ smitebasedamage }} true damage</trueDamage> to target large monster or lane minion.<br /><br />Deals <trueDamage>{{ firstpvpdamage }} true damage</trueDamage> to champion pets.',
				maxrank: 1,
				cooldown: [15],
				cooldownBurn: '15',
				cost: [0],
			...
			SummonerTeleport: {
				...
				name: 'Teleport',
				description:
					'After channeling for 3 seconds, become untargetable and travel to target allied structure, minion, or ward. Upgrades into Unleashed Teleport at 10 minutes, which significantly increases travel speed. ',
				tooltip:
					'After channeling for {{ channelduration }} seconds, become <keyword>Untargetable</keyword> and travel to target allied structure, minion, or ward. <br /><br />Upgrades into Unleashed Teleport at 10 minutes, which significantly increases travel speed.',
				maxrank: 1,
				cooldown: [300],
				cooldownBurn: '300',
				cost: [0],
