...
exports.getSummonersNameById = (id) => {
	// https://ddragon.leagueoflegends.com/cdn/14.8.1/data/en_US/summoner.json
	const summoners = {
		type: 'summoner',
		version: '14.8.1',
		data: {
			SummonerBarrier: {
				...
				tooltip:
					'\u003Cshield\u003EShields {{ tooltipabsorbeddamage }}\u003C/shield\u003E damage from your champion for 2 seconds.',
				maxrank: 1,
				cooldown: [180],
				cooldownBurn: '180',
				cost: [0],
			...
			SummonerHaste: {
				...
				tooltip:
					'Gain \u003Cspeed\u003E{{ movespeedmod }} Move Speed\u003C/speed\u003E for the next {{ duration }} seconds. Your champion can move through units for the duration.',
				maxrank: 1,
				cooldown: [210],
				cooldownBurn: '210',
				cost: [0],
			...
			SummonerHeal: {
				...
				effectBurn: [null, '0.3', '0', '0', '0.5', '826', '0.5', '0', '0', '0', '0'],
				vars: [],
				key: '7',
				summonerLevel: 1,
				modes: [
			...
			SummonerSmite: {
				id: 'SummonerSmite',
				name: 'Smite',
				description: 'Deals 600-1200 true damage to target monster.',
				tooltip:
					'Deals \u003CtrueDamage\u003E{{ smitebasedamage }} true damage\u003C/trueDamage\u003E to target monster or lane minion.\u003Cbr /\u003E\u003Cbr /\u003EDeals \u003CtrueDamage\u003E{{ firstpvpdamage }} true damage\u003C/trueDamage\u003E to champion pets.\u003Cbr /\u003E\u003Cbr /\u003E\u003Crules\u003ECannot be cast on small monsters.\u003C/rules\u003E',
				maxrank: 1,
				cooldown: [15],
				cooldownBurn: '15',
				cost: [0],
			...
			SummonerTeleport: {
				...
				tooltip:
					'After channeling for {{ channelduration }} seconds, your champion teleports to target allied structure.\u003Cbr /\u003E\u003Cbr /\u003EUpgrades to Unleashed Teleport at 10 minutes. Unleashed Teleport has a {{ upgradedcooldown }}s cooldown, can be used on allied structures, minions, or wards, and grants a {{ msamount*100 }}% Move Speed boost for {{ msduration }} seconds.',
				maxrank: 1,
				cooldown: [360],
				cooldownBurn: '360',
				cost: [0],
