	...
	const champions = {
		...
		data: {
			...
			Yunara: {
				...
				info: { attack: 9, defense: 2, magic: 0, difficulty: 4 },
				image: {
					full: 'Yunara.png',
					sprite: 'champion5.png',
					group: 'champion',
			...
			Zaahen: {
				...
				info: { attack: 8, defense: 6, magic: 1, difficulty: 2 },
				image: {
					full: 'Zaahen.png',
					sprite: 'champion5.png',
					group: 'champion',
...
exports.getSummonersNameById = (id) => {
	// https://ddragon.leagueoflegends.com/cdn/16.14.1/data/en_US/summoner.json
	const summoners = {
		type: 'summoner',
		version: '16.14.1',
		data: {
			...
			SummonerBoost: {
				...
				name: 'Cleanse',
				description:
					'Removes all disables (excluding suppression and airborne) and summoner spell debuffs affecting your champion and gives Tenacity.',
				tooltip:
			...
			SummonerHeal: {
				...
				name: 'Heal',
				description:
					'Restores Health and grants Move Speed to you and target allied champion.',
				tooltip:
			...
			SummonerSnowball: {
				...
				key: '32',
				summonerLevel: 6,
				modes: ['ARAM', 'FIRSTBLOOD', 'WIPMODEWIP5', 'KIWI'],
				costType: 'No Cost',
				maxammo: '-1',
				range: [1600],
				rangeBurn: '1600',
			...
			SummonerTeleport: {
				...
				tooltip:
					'After channeling for {{ channelduration }} seconds, become <keyword>Untargetable</keyword> and travel to target allied structure, minion, or ward. <br /><br />Upgrades into Unleashed Teleport at {{ upgrademinute }} minutes, which significantly increases travel speed.',
				maxrank: 1,
				cooldown: [300],
				cooldownBurn: '300',
				cost: [0],
